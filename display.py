...
def printDataToScreen( data, x ):
    print("\n\nStar number: %d \n" % x)
    print(tabulate(data, headers = ["Observation ID", "Observation Name", "Creator", "Project ID", "Right Ascension", "Declination"]))
...
def printDataToFile( data, outfile, x ):    
    ...
    fileWrite.write("\n\nStar number: %d \n" % x)
    fileWrite.write(tabulate(data, headers = ["Observation ID", "Observation Name", "Creator", "Project ID", "Right Ascension", "Declination"]))
