...
def printDataToScreen( data, x ):
    ...
    print("\n\nStar number: %d \n" % x)
    print(tabulate(data, headers = ["Observation ID", "Observation Name", "Creator", "Project ID", "Right Ascension", "Declination", "Start Time (UTC)", "Frequency (MHz)", "Correlation Mode", "Duration (sec)", "Offset from pointing centre (degrees)"]))
...
def printDataToFile( data, outfile, x ):    
    ...
    fileWrite.write("\n\nStar number: %d \n" % x)
    fileWrite.write(tabulate(data, headers = ["Observation ID", "Observation Name", "Creator", "Project ID", "Right Ascension", "Declination", "Start Time (UTC)", "Frequency (MHz)", "Correlation Mode", "Duration (sec)", "Offset from pointing centre (degrees)"]))
